...
/// Settings screen: language, sessions, cloud password, feedback,
/// support tickets, sticker packs, server URL override, logout.
@Observable
@MainActor
final class SettingsViewModel {
    ...
    // MARK: - Server URL / logout

    /// Changing the backend invalidates the JWT (sessions live server-side),
    /// so it logs out to the auth screen — same as switching accounts.
    func applyServerURL() {
