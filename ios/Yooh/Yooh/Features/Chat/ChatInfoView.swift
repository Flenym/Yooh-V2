...
/// Group / channel / direct info: details, settings, members, roles,
/// moderation, invites, shared media, scheduled messages, danger zone.
...
/// Member picker with people/bot mode.
