...
///
/// Server avatars arrive inline as `data:...;base64,...` (≤2MB); empty
/// string means "no avatar". Remote file URLs are not used for avatars.
...
/// Synchronous decode + NSCache (data-URLs are already in memory).
enum AvatarLoader {
