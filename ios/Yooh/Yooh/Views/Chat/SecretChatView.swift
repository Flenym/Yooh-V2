...
/// Device-local secret chat: messages never leave this phone, an optional
/// self-destruct timer removes them, and the fingerprint identifies the
/// pairing. Same semantics as the web client's secret chats.
