...
/// location, polls, voice notes. Floating glass bar, keyboard-aware.
struct ComposerView: View {
    ...
    private var PhotosPickerButton: some View {
        // PhotosPicker as a Menu item needs the modern initializer.
    ...
    private func sendCurrentLocation() {
        ...
        Task {
            ...
            // Local keeps the provider (and its CLLocationManager) alive
...
/// Camera capture (PhotosPicker can't do camera).
