...
struct MessageBubbleView: View {
    ...
    var body: some View {
            ...
            VStack(alignment: message.isOutgoing ? .trailing : .leading, spacing: 3) {
                ...
                content
                    ...
                    .background(message.isOutgoing ? YoohTheme.Colors.outgoingBubble : YoohTheme.Colors.incomingBubble,
                                in: .rect(cornerRadius: YoohTheme.Radius.l))
        ...
        .contextMenu {
            ...
            Button {
                // Forward sheet is presented by the parent via notification-free
                // state: reuse the view-model-owned pending forward slot.
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: YoohTheme.Spacing.s) {
            ...
            if let text = message.text, !text.isEmpty {
                Text(text).font(YoohTheme.Type.message)
            }
        }
