...
/// Displays a QR login code: scan it from another logged-in device to
/// authorize it there. Polls `qr/status` until approved or expired.
/// (The reverse direction — scanning — lives in LinkDeviceView.)
