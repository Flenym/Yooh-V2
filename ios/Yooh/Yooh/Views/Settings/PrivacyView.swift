...
/// Privacy controls enforced server-side (privacyRules.js):
/// last-seen visibility, profile-photo visibility, calls, forwards and
/// read receipts (the latter feeds `hideReadTime` on the backend).
