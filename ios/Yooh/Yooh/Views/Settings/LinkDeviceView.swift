...
/// Links a desktop/web login: scan its QR code (or paste the code) to
/// authorize the pending session via POST /api/auth/sessions/link-device.
/// Same contract as the web client's session scanner.
