...
/// Readers for the server-merged `user.settings` sections
/// (`notifications`, `privacy`, `data`, `appearance`).
enum SettingsReader {
...
/// Audience values enforced server-side (privacyRules.js).
...
/// One server-backed toggle row with error surfacing.
...
/// Audience picker row (everyone/contacts/nobody).
